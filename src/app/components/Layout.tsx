...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#05445E] via-[#189AB4] to-[#05445E]">
      <Header />
        ...
        {pathname !== "/" && (
          <div className="relative py-20 mb-8 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative">
              <h1 className="text-5xl md:text-6xl font-bold text-center text-white">{getPageTitle(pathname)}</h1>
            </div>
          </div>
        )}
        {children}
